...
/* Last-Modified: Sun, 17 Mar 2024 10:06:15 GMT */
const uint32_t imageLastModified = 1710669975U;

static const uint8_t imageFileData[25697U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xCEC97D75U, &imageFileData[11395U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[13543U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14794U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15438U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18254U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19643U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[20781U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22568U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25576U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25697U] }
};
